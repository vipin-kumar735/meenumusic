...
API_KEY = getenv("API_KEY", '30DxNexGenBots5fe9ae') # youtube song api ke

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/vipin-kumar735/meenumusic",
)
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+IYo9DD-sTc0xYjZl")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/69k520.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/69k520.jpg"
)
